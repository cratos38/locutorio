#!/usr/bin/env python3
"""
ML Photo Validator v3.4-TOLERANT - Face Matching con Threshold Mejorado
========================================================================

CAMBIOS EN v3.4-TOLERANT:
- 🔧 Face matching threshold: 0.4 → 0.6 (más tolerante)
- ✅ Acepta misma persona con diferentes ángulos, iluminación, expresión
- ✅ Todas las validaciones de v3.4 funcionando
- ✅ Face matching ACTIVADO por defecto (no como v3.5)

Validaciones implementadas:
- ✅ Detección de rostros (face_recognition dlib)
...
- ✅ Face Matching - threshold 0.6 (era 0.4 en v3.4)
...
VALIDATION_CONFIG = {
    ...
    'album': {
        # ÁLBUM PÚBLICO: Solo validar NSFW + OCR (palabras vulgares/propaganda) + Armas/Drogas
        'nsfw_enabled': True,
        'nsfw_strict': True,  # Solo rechazar explícito, permitir cuestionable
        'ocr_enabled': True,
        ...
        'auto_delete_weapons_drugs': True,  # Borrar automáticamente armas/drogas
        # NO validar rostros, nitidez, face matching, AI
        'face_detection_enabled': False,
        'face_matching_enabled': False,
        'ai_detection_enabled': False,
        'quality_check_enabled': False,
        'crop_enabled': False  # NO recortar fotos de álbum
    }
}
...
PROHIBITED_OBJECTS = {
    ...
    # ÁLBUM: Solo armas y drogas (con borrado automático)
    'album': {
        'knife': {'threshold': 0.6, 'severity': 'high', 'auto_delete': True},
        'scissors': {'threshold': 0.6, 'severity': 'high', 'auto_delete': True},
        # NO validar alcohol en álbumes (pueden estar en bar/fiesta)
    }
}
...
# ============================================================================
# FUNCIONES DE VERIFICACIÓN DE IDENTIDAD - NUEVO v3.4
# ============================================================================
...
def verify_identity_document(selfie_url, user_id, profile_age):
    """
    Verificación completa de identidad con documento
...
# ============================================================================
# FUNCIÓN PRINCIPAL DE VALIDACIÓN (sin cambios, v3.3)
# ============================================================================
...
def validate_and_crop_photo(photo_url, photo_type='profile', user_id=None, user_gender=None, user_age=None):
    ...
    try:
        ...
        print("\n" + "="*70)
        print(f"🔍 VALIDANDO FOTO v3.4: {photo_type.upper()}")
        if user_id:
            print(f"👤 Usuario: {user_id}")
...
if __name__ == '__main__':
    print("\n" + "="*70)
    print("🚀 ML VALIDATOR v3.4-TOLERANT")
    print("✨ Face Matching con Threshold Mejorado: 0.4 → 0.6")
    print("="*70)
    print("\n📍 ENDPOINTS:")
    ...
    print("   ✅ Identity Verification - ID/Cédula verification (NEW v3.4)")
    print("="*70 + "\n")
