          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="bg-[#1A2226] border border-white/5 shadow-lg rounded-xl p-6 relative overflow-hidden group">
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                <Link href="/perfil-usuario" className="block w-full">
            ...
            <div className="bg-[#1A2226] border border-white/5 rounded-xl overflow-hidden">
              ...
              <div className="p-2 space-y-1">
                ...
                <Link href="/encuentros" className="flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-white/5 text-gray-400 hover:text-white transition-colors group">
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 group-hover:text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <Link href="/albumes" className="flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-white/5 text-gray-400 hover:text-white transition-colors group">
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 group-hover:text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="bg-connect-card border border-connect-border rounded-xl p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <Link href="/personas" className="text-xs text-primary hover:underline">
                  Ver más
                </Link>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-connect-card border border-connect-border rounded-xl p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Link href="/encuentros" className="text-xs text-primary hover:underline">
                    Ver más
                  </Link>
                </div>
